...
sagemaker_hpo_op = components.load_component_from_url('https://github.com/kubeflow/pipelines/raw/master/components/aws/sagemaker/hyperparameter_tuning/component.yaml')
...
sagemaker_process_op = components.load_component_from_url('https://github.com/kubeflow/pipelines/raw/master/components/aws/sagemaker/process/component.yaml')
...
sagemaker_batch_transform_op = components.load_component_from_url('https://github.com/kubeflow/pipelines/raw/master/components/aws/sagemaker/batch_transform/component.yaml')
...
def mnist_classification(role_arn="", bucket_name=""):
    ...
    train_image = "174872318107.dkr.ecr.us-west-2.amazonaws.com/kmeans:1"
    ...
    process = sagemaker_process_op(
        role=role_arn,
        region=region,
        image="763104351884.dkr.ecr.us-west-2.amazonaws.com/pytorch-training:1.5.0-cpu-py36-ubuntu16.04",
        ...
        input_config=[
            processing_input(
                "mnist_tar",
                f"s3://{bucket_name}/mnist_kmeans_example/mnist.pkl.gz",
